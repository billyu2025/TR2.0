...
Description:	BBS with missing TR will not sync to DW.  Only BBS with DD will sync to DW.
*/
...
print('start: get list of BBS with missing TR')
	-- get list of BBS with missing TR
	...
	where
		tld.product is null
print('end: get list of BBS with missing TR')
	...
	join #bbs_with_missing_tr bbs
		on bbs.bbs_no = t.bbs_no
